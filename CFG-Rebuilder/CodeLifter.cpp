...
namespace {
     ...
     constexpr size_t TRAMPOLINE_PER_FUNC = 64;   // ÿ������������Ԥ�� 64 �ֽ�
}


CodeLifter::CodeLifter(uint32_t targetPid, MemoryBackend backend)
     : m_mem(targetPid, backend)
     , m_resolver(m_mem)
     , m_pdata(m_mem)
     , m_arena(ARENA_RESERVE_SIZE, COMMIT_CHUNK_SIZE)
     , m_scanner(m_mem, m_pdata)
{
     // ģ���б����ڹ��� DLL �жϣ�ModuleResolver ��Ȼ��Ҫ��
